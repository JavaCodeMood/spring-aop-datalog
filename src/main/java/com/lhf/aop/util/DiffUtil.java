package com.lhf.aop.util;

import ch.qos.logback.classic.gaffer.PropertyUtil;
import com.alibaba.fastjson.JSON;
import com.lhf.aop.datalog.Datalog;
import com.lhf.aop.domain.ChangeItem;
    ...
    public static Map<String, String> getBeanSimpleFieldValueMap(Object bean, boolean filterNull){
        ...
        try{
            ...
            for(int i = 0;i<fields.length;i++){
                ...
                if(isBaseDataType(filedType)){
                    String strValue = getFieldStringValue(filedType, value);
